  ...
  return (
    <div className="flex">
      <div className="relative box-border flex-1">
        <div className="sticky top-[calc(var(--height-header)+67px)] sm:top-[--height-header] flex flex-col gap-2 w-[calc(100%-12px)] sm:w-[calc(100%-22px)] lg:w-[calc(100%-42px)] mx-auto bg-white z-[2]">
