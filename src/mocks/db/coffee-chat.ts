...
export const mockCoffeeChatReservations: Array<MockCoffeechat> = [
  ...
  },
  {
    ...
    date_times: [
      ...
      },
      {
        ...
        mentee_nickname: mockUsers[3].nickname,
        mentee_image_url: mockUsers[3].image_url,
      },
      {
        reservation_id: 41,
        room_id: 41,
  ...
  },
  {
    article_id: 17,
    title: "프론트엔드 React",
    content: "프론트엔드 React 에 대해 알아봅시다.",
    introduction: "프론트엔드 React 심화",
    member_id: mockUsers[1].id,
    member_image_url: mockUsers[1].image_url,
    nickname: mockUsers[1].nickname,
    level: mockUsers[1].level,
    level_image_url: badge_url[mockUsers[1].level],
    hash_tag_list: ["React", "프론트엔드"],
    date_times: [
      {
        reservation_id: 35,
        room_id: 35,
      ...
      },
      {
        reservation_id: 36,
        room_id: 36,
        start_time: "2024-05-13T12:00:00Z",
        mentee_nickname: null,
        mentee_image_url: null,
      },
    ],
    created_date: "2024-05-05T06:40:02Z",
    modified_date: "2024-05-05T06:40:02Z",
    article_status: true,
    coffee_chat_count: 0,
    available_reservation_count: 1,
    total_reservation_count: 2,
